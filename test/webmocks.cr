...
WebMock.stub(:get, "https://api.openweathermap.org/data/2.5/onecall?lat=43.5789&lon=-79.6583&appid=NOTAREALKEY").to_return(status: 200, body: File.read("test/files/onecall.json"))
