...
class CurrentWeatherTest < Minitest::Test
  def cairns : OpenWeatherMap::CurrentWeather
  ...
  def tromso : OpenWeatherMap::CurrentWeather
  ...
  def three_conditions : OpenWeatherMap::CurrentWeather
  ...
  def mississauga : OpenWeatherMap::CurrentWeather
